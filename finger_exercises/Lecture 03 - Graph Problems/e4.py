...
# Use the enumeration we established when adding the nodes to our graph. That
# is,
class Node(object):
...
# is connected to Nodes 3 and 4, the first path checked will be 23.
# Additionally, DFS will never return to a node already in its path.
#
...
# three edges! In this graph, given a random source and a random destination,
# what is the probability of DFS finding a path of the shortest possible
# length?
#
# ans: 4/6
