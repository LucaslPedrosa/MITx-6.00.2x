...
# julytemps.txt containing the daily maximum and minimum temperatures for each
# day in Boston for the 31 days of July 2012. In the loop, we need to make sure
# we ignore all lines that don't contain the relevant data.
...
#
#
# Suppose you defined diffTemps = list(numpy.array(highTemps) -
# numpy.array(lowTemps)) to be a list which is the element-by-element
# difference between highTemps and lowTemps. Which is a valid plotting
# statement for a graph with days on the horizontal axis and the temperature
