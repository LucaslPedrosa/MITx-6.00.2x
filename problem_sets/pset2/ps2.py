...
class RectangularRoom(object):
    ...
    def __init__(self, width, height):
        ...
        self.width = width
        self.height = height
        self.cleaned_tiles = set() # set of (m, n) tuples representing cleaned tiles
    ...
    def cleanTileAtPosition(self, pos):
        ...
        self.cleaned_tiles.add((int(pos.getX()), int(pos.getY())))
...
class Robot(object):
    ...
    def __init__(self, room, speed):
        ...
        # self.updatePositionAndClean() # clean the tile the robot is on
...
showPlot1("Time to Clean 80% of a 20x20 Room", "Number of Robots", "Time Steps")
...
showPlot2("Effect of Aspect Ratio on Cleaning Time (Area=300)", "Aspect Ratio", "Time Steps")
